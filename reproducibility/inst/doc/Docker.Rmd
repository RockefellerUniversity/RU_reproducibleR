...
3. Activate the conda environment that contains salmon and confirm the version that you have installed
...
4. Use salmon to get counts for the fastq files present in the 'data/docker_exercise' folder within the course files. 
...
5. Read in the quant.sf result file into R and plot a bar graph showing the number of reads for each of the genes in the fasta file. 
...
6. Push this image to Docker Hub
