...
alt_PAT <- Sys.getenv("GITHUB_PAT_alt")
...
* **rebase** - Helps manage multiple bracnes. When the master is updated, any new commits can then be added to a branch. 


Take exisitng commits and put it on branch that is new
rebase allows new edits to master to be integrated into the branch
Generally for your own branch then update it if it has lost pace with asmter. Will update it. Replays master, then Adds your commits after to the newly modified master. 
