...
R contains a ton of useful tools and functions which allow us to perform more complex operations _out of the box_.
...
Packages listed **Depends and Imports** are dependencies of this package and if not already installed are installed alongside this package.
...
By simply loading two libraries i wanted to use, i am now managing the dependencies of these packages as well adding up to ~ 70 packages in total.
