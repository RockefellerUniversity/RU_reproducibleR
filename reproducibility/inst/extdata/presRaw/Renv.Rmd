...
The current version of the R software is **4.4.3**
...
e.g. ggplot2 current version is **ggplot2** - **3**_._**5**_._**1**
...
* [RSwitch](https://rud.is/rswitch/) - This utility is specific to Macs, but it allows quick and easy switching between R versions (along with other R management options). For users on other OS they can change global options in RStudio. 
