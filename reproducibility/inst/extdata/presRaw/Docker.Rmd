...
Then create a repository with the same name as the image we want to push, in this case it would be 'rstudio_4.4.0_samtools'. A repository must exist on Docker Hub before pushing to it. 
