...
So far we have only been using the R Studio Docker image, but we can also use Docker to run a specific version or R and R packages in the terminal interactively. The Rocker suite has images that just contain R, without R studio. 
