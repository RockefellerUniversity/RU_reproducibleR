...
Images have names, tags, and image IDs as shown in the output from 'docker images'. Tags allow you to track different versions of an image, and the ID is the unique identifier for the name:tag combination. If a tag is not specified, Docker will use 'latest' by default
...
To add a tag, use the 'docker tag' command.
